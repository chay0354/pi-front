...
const PostEditorScreen1 = ({
  ...
  const [isEditingTextModeOverlay, setIsEditingTextModeOverlay] =
    useState(false);
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      const listingData = {
        ...
        phone: null,
        ...(description &&
          (overlayText || textModeOverlayText) && {
        ...
        isEditingTextModeOverlay ? (
          <View style={styles.flex1}>
            <View style={styles.textModeContainer}>
              <View
                style={[
                  styles.textModeCanvasWrap,
                  {height: TEXT_CANVAS_HEIGHT},
                ]}>
                <LinearGradient
                  colors={
                    TEXT_MODE_BACKGROUNDS[selectedStyleIndex] ||
                    TEXT_MODE_BACKGROUNDS[0]
                  }
              ...
              {overlayText ? (
                <View
                  style={[
                    styles.overlayTextDraggable,
                    {
                      left: isEditingOverlay
                        ? editPositionRef.current.x
                        : overlayX,
                      top: isEditingOverlay
                        ? editPositionRef.current.y
                        : overlayY,
                    },
                  ]}
                  {...(!isEditingOverlay
          ...
          <View style={styles.cameraSideIcons}>
            ...
            {mediaUri && (
              <TouchableOpacity
                style={[
                  styles.sideIcon,
                  overlayText ? styles.sideIconActive : null,
                ]}
                onPress={() => {
                  if (overlayText) {
                    setOverlayText('');
...
const styles = StyleSheet.create({
  ...
  tab: {paddingVertical: 6, paddingHorizontal: 5},
  tabActive: {},
...
export default PostEditorScreen1;
